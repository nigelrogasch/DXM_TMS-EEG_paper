%##### COMPARE CHANGES IN TEPS FOLLOWING DRUG AT CERTAIN PEAKS #####
...
% Note that find_gmfa_peaks.mat must be run prior to this script.
...
% % Comparisons of interest - within condition
% comparisons = {{'C1','pfc','T0'},{'C1','pfc','T1'};...
%     {'C2','pfc','T0'},{'C2','pfc','T1'}}; %PFC comparisons
comparisons = {{'C1','ppc','T0'},{'C1','ppc','T1'};...
    {'C2','ppc','T0'},{'C2','ppc','T1'}}; %PPC comparisons
