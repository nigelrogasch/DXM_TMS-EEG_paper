% ##### CALCULATE L2-MNE ON TIME POINTS OF INTEREST #####

% This script calculates an l2-MNE on time points of interest for each
% individual, converts the result on to a template brain, and then saves
% the output.
