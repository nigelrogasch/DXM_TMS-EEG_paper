...
% This script plots topoplots at two time points showing t
% statistics/results of cluster-based permutation tests and the changes in
% TEPs at two different electrodes for PAR stimulation following
% dextromethorphan.
% Inputs are the grand average structure of the EEG data generated by 
% FieldTrip, and the output of cluster-based permutation tests 
% (time x drug interaction).
